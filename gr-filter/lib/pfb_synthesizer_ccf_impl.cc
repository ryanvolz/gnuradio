...
pfb_synthesizer_ccf::sptr pfb_synthesizer_ccf::make(unsigned int numchans,
...
void pfb_synthesizer_ccf_impl::set_taps1(const std::vector<float>& taps)
{
...
void pfb_synthesizer_ccf_impl::set_taps2(const std::vector<float>& taps)
{
...
void pfb_synthesizer_ccf_impl::print_taps()
{
    unsigned int i, j;
...
std::vector<std::vector<float>> pfb_synthesizer_ccf_impl::taps() const { return d_taps; }
...
std::vector<int> pfb_synthesizer_ccf_impl::channel_map() const { return d_channel_map; }

int pfb_synthesizer_ccf_impl::work(int noutput_items,
